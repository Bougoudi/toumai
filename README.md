...
| --- | --- | --- | --- |
| **Touma — place de marché** | Commerce B2B/B2C entre pays africains : catalogue, panier multi-vendeurs, paiements, logistique, points relais, confiance, litiges, messagerie, appels d'offres B2B, retours et remboursements, assistance et IA. Corridor pilote **Tchad ↔ Cameroun**. | `/touma/` | `/api/v1` |
...
```bash
npm test              # 149 tests : unitaires, intégration et parcours complet (Node ≥ 22)
